...
public interface ReservationRepo extends JpaRepository<Reservation, String> {
        ...
        public Page<Reservation> findByOwner(@Param("owner") User owner, Pageable pageable,
                        @Param("status") Byte status,
                        @Param("isPast") Boolean isPast);

        public Optional<Reservation> findByHotel(Hotel hotel);

        public Optional<List<Reservation>> findByHotelIdAndUser(String id, User user);
}
